/************************************************************
*
*   6.30 This program is a driver for testing the showFees
*        function.
*
 ...
 * parameter holds the monthly membership rate and the  *
 * months parameter holds the number of months. The     *
 * function displays the total charges.                 *
 ********************************************************/
