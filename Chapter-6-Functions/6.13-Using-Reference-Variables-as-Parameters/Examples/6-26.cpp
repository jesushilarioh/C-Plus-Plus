/************************************************************
*
*   6-26. This uses a reference varaiables as a function
*         parameters.
*
 ...
 * The parameter userNum is reference variable. The     *
 * user is asked to enter a number, which is stored in  *
 * userNum.                                             *
 ********************************************************/
 ...
 * The parameter refVar is a reference variable. The    *
