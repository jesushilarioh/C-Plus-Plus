/************************************************************
*
*   6.28 This program demonstrates overloaded functions to
 ...
 * This function calculates the gros weekly pay of an   *
 * hourly paid employee. The parameter hours holds the  *
 * hourly pay rate. The function returns the weekly     *
 * salary.                                              *
 ********************************************************/
 ...
 * employee's annual salary. The function returns the   *
 * weekly salary.                                       *
 ********************************************************/
