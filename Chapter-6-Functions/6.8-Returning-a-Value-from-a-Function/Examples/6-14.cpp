/********************************************************************
*
*	  6-14. This program converts cups to fluid ounces.
*
...
/************************************************************
 * The getCups function prompts the user to enter the number*
 * of cups and then returns that value as a double.         *
 ************************************************************/
double getCups()
{
    double numCups;
...
/************************************************************
 * The cupsToOunces function accepts a number of cups as an *
 * argument and returns the equivalent number of fluid      *
 * ounces as a double.                                      *
 ************************************************************/
