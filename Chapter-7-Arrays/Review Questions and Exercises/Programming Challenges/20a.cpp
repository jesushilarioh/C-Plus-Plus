...
int main()
{
    ...
    do
    {
        ...
        cin >> menu_option;
        cout << "menu_option = " << menu_option << endl;

        // Options
        // 1. Purchase a seet
        // 2. see how many seats have sold
        // 3. see how many seats are available in each row
        // 4. see how many seats are available in the entire auditorium
        // 5. view ticket sales
        // 6. Quit Program
...
void displayMenu()
{
    cout << "\nChoose from menu: " << endl
         << "1. Purchase a seat" << endl
         << "2. See how many seats have sold" << endl
         << "3. See how many seats are available in each row" << endl
         << "4. See how many seats are available in the entire auditorium" << endl 
         << "5. View ticket sales" << endl
         << "6. Quit Program." << endl
         << endl;
}